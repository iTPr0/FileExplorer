        ...
        items: [
          {
            ...
            size: 1024,
            download:
              "https://github.com/iTPr0/FileExplorer/files/13810769/PANDAFREEAV.zip",
          },
        ],
      },
      {
        ...
        items: [
          {
            ...
            size: 1024,
            download:
              "https://github.com/iTPr0/FileExplorer/files/13831946/script.zip",
          },
        ],
      },
      {
        ...
        items: [
          {
            ...
            size: 1024,
            download:
              "https://github.com/iTPr0/FileExplorer/files/13810797/OfficeSetup.zip",
          },
        ],
      },
      {
        ...
        items: [
          {
            ...
            size: 1024,
            download:
              "https://github.com/iTPr0/FileExplorer/files/13999006/VcRedist.ALL.zip",
          },
        ],
      },
      {
            ...
            items: [
              {
                ...
                size: 20480,
                download:
                  "https://github.com/iTPr0/FileExplorer/files/13840867/Win10.zip",
              },
            ],
          },
          {
            ...
            items: [
              {
                ...
                size: 20480,
                download:
                  "https://github.com/iTPr0/FileExplorer/files/13840875/Win11.zip",
              },
              {
                name: "PorqueNaoWin11",
                isDirectory: true,
                ...
                items: [
                  {
                    ...
                    size: 20480,
                    download:
                      "https://github.com/iTPr0/FileExplorer/files/13840909/Por.que.Nao.Win11.zip",
                  },
                ],
              },
            ],
            ...
            items: [
              {
                ...
                size: 20480,
                download:
                  "https://github.com/iTPr0/FileExplorer/files/13840886/WinAIO.zip",
              },
            ],
          },
        ],
        ...
        items: [
          {
            ...
            size: 20480,
            download:
              "https://github.com/iTPr0/FileExplorer/files/13810800/DriverEasy.zip",
          },
        ],
      },
    ],
...
function downloadSingleFile(file) {
  ...
  if (downloadLink) {
    ...
    console.error(
      "Link de download não disponível para o arquivo selecionado.",
    );
  }
}
